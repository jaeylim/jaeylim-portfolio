...
PCI-DSS 12개 요구사항에 대응하기 위해 구성한 AWS 인프라 아키텍처입니다. 실제 고객사명·리소스명은 일반화하여 표기하였습니다.
...
#### CloudHSM과 KMS의 관계 (특이사항)

- KMS는 기본적으로 AWS 관리형 소프트웨어 기반 키 스토어를 사용하지만, PCI-DSS 등 규제 준수를 위해 **KMS Custom Key Store**를 CloudHSM 클러스터에 연결하는 구조로 구성
